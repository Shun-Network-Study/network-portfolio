...
## 自己紹介・ポートフォリオの概要
前職は映像ディレクターとして従事しておりましたが、より長期的な成長と社会的な安定を求めてIT業界へのキャリアチェンジを決意し、未経験からネットワークエンジニアとしてのキャリアを志望しております。<br>
重要な社会基盤を支えるネットワーク技術に強い関心を持ち将来性を感じ、2025年5月にCCNA（Cisco Certified Network Associate）を取得しました。<br>
現在は、ネットワーク構築スキルをさらに高めるため、Cisco Packet TracerとCisco Modeling Labsを用いたハンズオン学習を継続しています。

このリポジトリでは、「ネットワーク構築マラソン」（株式会社CAIRN 運営）に取り組み、ネットワーク構成図、設定内容、検証結果などをまとめています。<br>
実務未経験ではありますが、実務を想定した構築課題に取り組み、設定ミスの切り分けや通信確認などのトラブルシューティングの思考プロセスを可視化しています。<br>
